...
var PDFViewerApplication = {
  ...
  setTitleUsingUrl: function pdfViewSetTitleUsingUrl(url) {
    ...
    // title = (!!window.parent.T && !!window.parent.T.data('pdf_title')) ? window.parent.T.data('pdf_title') : title;
    this.setTitle(title);
  },
  ...
  setTitle: function pdfViewSetTitle(title) {
    ...
    document.getElementById('title').textContent = title;
     ...
     obj.style.width=window.screen.width-20 +'px';
  },
...
PDFViewerApplication.animationStartedPromise.then(function () {
  ...
  // console.log(window.parent.T)
  var closeBtn = document.getElementById('title'), T = window.parent.T
  !!T && T.$store.commit('test')
  !!T && T.$store.commit('pdfIframeOpen')
  debugger
  closeBtn.addEventListener('click', function () {
    !!T && T.$store.commit('pdfIframeClose')
  })
})
