var EleResize = {
    _handleResize: function (e: Event) {
        var ele: any = e.target || e.srcElement;
    ...
    _removeHandler: function (ele: any, handler: Function, context: any) {
    ...
    on: function (ele: any, handler: Function, context?: any) {
        if ('attachEvent' in document) {
            ...
            if (!handlers) {
                ...
                var obj: any = EleResize._createResizeTrigger(ele);
    ...
    off: function (ele: any, handler: Function, context: any) {
        if ('attachEvent' in document) {
            var handlers = ele.__z_resizeListeners;
            if (handlers) {
